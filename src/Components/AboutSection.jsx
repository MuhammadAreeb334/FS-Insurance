...
// Updated AboutSection.jsx with progressive scroll animations
import React from "react";
...
const AboutSection = () => {
  ...
  // Remove useInView - we'll use whileInView directly on motion components

  return (
    <section className="bg-white pt-8 pb-4 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

        {/* Each element animates independently as you scroll */}
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-start mb-12 md:mb-16">
          
          {/* LEFT - Animates when scrolled into view */}
          <div>
            <motion.div
        ...
        {/* Cards section with sequential animation on scroll */}
        <div className="flex flex-col lg:grid lg:grid-cols-3 gap-6 md:gap-8">
          <div className="grid sm:grid-cols-2 lg:grid-cols-1 gap-4 md:gap-6">
            
            {/* Mission Card - animates when scrolled */}
            <motion.div
            ...
            {/* Vision Card - animates with delay */}
            <motion.div
              initial={{ x: -50, opacity: 0 }}
              whileInView={{ x: 0, opacity: 1 }}
              viewport={{ once: false, amount: 0.3 }}
